...
using alainsoftech.core.Infrastructure.Mapper;

namespace alainsoftech.core.Infrastructure
{
    public class Engine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(AppConfig config)
        {
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(AppConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
